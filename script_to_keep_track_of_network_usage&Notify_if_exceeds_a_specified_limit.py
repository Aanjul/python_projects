# For refrence https://github.com/avinashkranjan/Amazing-Python-Scripts/blob/master/Bandwidth-Monitor/bandwidth_py3.py

# https://github.com/adarshkushwah/Network-Usage-Tracker
...
def main():
	if len(sys.argv) > 3 or len(sys.argv) < 3:
		...
		print('or python3 bandwidht_py3.py 2 GiB')
		exit(1)
	else:
