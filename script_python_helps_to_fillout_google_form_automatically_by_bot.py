# For refrence https://github.com/avinashkranjan/Amazing-Python-Scripts/blob/master/Auto-Fill-Google-Forms/test.py

#https://github.com/avinashkranjan/Amazing-Python-Scripts/tree/master/Auto-Fill-Google-Forms 
...
# Put the fields name here that you want to autofill
inputName = '/html/body/div/div[2]/form/div[2]/div/div[2]/div[1]/div/div/div[2]/div/div[1]/div/div[1]/input'
input EmailID = '/html/body/div/div[2]/form/div[2]/div/div[2]/div[2]/div/div/div[2]/div/div[1]/div/div[1]/input'
