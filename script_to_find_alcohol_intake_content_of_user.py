# For refrence https://github.com/avinashkranjan/Amazing-Python-Scripts/blob/master/Blood%20Alcohol%20Content/Blood_Alcohol_Content.py


class BAC(object):
	def __init__(self,weight, time, vol, amout, gender):
		self.weight = weight
		self.time = time
		self.vol = vol
		self.amount = amount
