# For refrence https://github.com/Logan1x/Python-Scripts/blob/master/bin/findlargefiles.py
...
def search_folder(location, min_file_size):
	...
	print(f'Files found: {files_found_cost}')
	print(f'Total size: {(total_size/1024**2):.2f} MB')
	if file_not_found_errors_count > 0:
		print(f'FileNotFoundError: {file_not_found_errors_count}')
...
if __name__ == '__main__':
	...
	while True:
		...
		for foldername, filename, actual_size in search_folder(location, min_file_size):
