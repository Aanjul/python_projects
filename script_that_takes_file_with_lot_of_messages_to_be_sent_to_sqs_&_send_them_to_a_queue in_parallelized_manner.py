# For refrence https://github.com/hastagAB/Awesome-Python-Scripts/blob/master/send_sqs_messages_in_parallel/send_to_sqs.py
...
def main(file):
	...
	for _ in Pool(processes=processor_count).imap_unordered(send_message, batched_data):
