#For refrence https://github.com/realpython/python-scripts/blob/master/scripts/25_ip2geolocation.py
...
def get_geolocation(all_the_ip_address):
    """
    Given a list of lists from `get_addresses()`, this function returns an updated lists of lists containing the geolocation.
    returns as updated lists of lists containing the geolocation.
    """
    ...
    for line in all_the_ip_address:
        ...
        def create_csv(updated_addresses_list):
            """
