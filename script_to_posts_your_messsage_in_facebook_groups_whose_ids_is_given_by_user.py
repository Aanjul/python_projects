# For refrence https://github.com/avinashkranjan/Amazing-Python-Scripts/blob/master/Automate%20Facebook%20bot/script.py
		...
		if browser == 'Chrome':
			...
			def login(self):
				...
				for i in range(len(groupid)):
					link = 'https://facebook.com/groups/'+group[i]
					...
					self.driver.find_element_by_class_name(
						'a8c37x1j ni8dbmo4 stjgntxs 19j0dhe7')
					time.sleep(7)
