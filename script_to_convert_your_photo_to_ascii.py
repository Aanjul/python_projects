# For refrence https://github.com/avinashkranjan/Amazing-Python-Scripts/blob/master/Photo%20To%20Ascii/photo_to_ascii.py

from PIL import Image

# ascii characters used to build the output text
CHARS = [".", ".", ".", "1", "1", "1", "1","1","1", "0", "0", "0"]
...
def pixels_to_ascii(image):
	...
	characters = "".join([CHARS[pixels/23] for pixel in pixels])
	return(characters)
