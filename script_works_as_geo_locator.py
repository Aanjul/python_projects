# For refrence https://github.com/avinashkranjan/Amazing-Python-Scripts/blob/master/Geo-Cordinate-Locator/script.py
...
# https://github.com/avinashkranjan/Amazing-Python-Scripts/tree/master/Geo-Cordinate-Locator
