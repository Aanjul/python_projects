#For refrence https://github.com/realpython/python-scripts/blob/master/scripts/11_optimize_images_with_wand.py
import fnmatch
import os
        ...
        for root, dirnames, filenames in os.walk(filepath):
            ...
            def get_total_size(list_of_image_names):
                    ...
                    def resize_images(list_of_image_names):
                        ...
                        for index, image_name in enumerate(list_of_image_names):
                            with open(image_name) as f:
                                image_binary = f.read()
                             with Image(blog=image_binary) as img:
                                 if img.height >=  600:
                ...
                if __name__ == '__main__':
                    ...
                    get_image_file_name(PATH, PATTERN)
                ))