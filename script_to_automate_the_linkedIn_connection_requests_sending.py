# For refrence https://github.com/fnplus/Python-scripts-collection/blob/master/AutoLinkedIn/AutoLinkedIn.py
...
password.send_keys("password")                          # Sending the keys for password
  driver.find_element_by_id("login-submit").click()     # Getting tag for submit button
...
def send_requests():
	n= input("Number of requests: ") # Number of requests you want to send
for i in range(0,n):
