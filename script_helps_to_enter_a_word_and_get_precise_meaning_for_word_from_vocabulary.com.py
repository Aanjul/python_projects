# For refrence https://github.com/OmkarPathak/Python-Programs/blob/master/Scripts/P06_GetMeaning.py
# https://github.com/OmkarPathak/Python-Programs/tree/master/Scripts
