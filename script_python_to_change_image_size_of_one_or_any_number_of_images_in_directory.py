# For refrence https://github.com/fnplus/Python-scripts-collection/blob/master/ImageSizeConvertor/Script.py
#Requirement Python 3.5+,OpenCV 2
...
for files in onlyfiles:
	a +=1
	if ( '.jpg' in files or '.jpeg' in files or '.png' in files): #Add more formats here if you want
