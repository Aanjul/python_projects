# For refrence https://github.com/avinashkranjan/Amazing-Python-Scripts/tree/master/Run-Script-At-a-Particular-Time
...
with open(datetime.now().strftime("%Y-%m-%d-%H-%M-%S"), "w") as myfile:
	# instead of now i could also initialse with datetime(1999, 12, 12, 12, 12, 12, 12, 342380) to give the time values to datetime constructor
	# Content of the file (it can be any script in python which we want to run at a particular time )
	myfile.write("hii guys ,your this running as per the time ")
