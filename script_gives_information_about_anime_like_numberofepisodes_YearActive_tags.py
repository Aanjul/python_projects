# For refrence https://github.com/avinashkranjan/Amazing-Python-Scripts/blob/master/Anime-Tracker/anime_tracker.py
...
def details(soup):
	...
	print("\nTotal number of episodes :\t",
		re.sub(
			"[^0-9]", "",
			total_episodes.find(
				'span').getText())) # using regex for only selecting numbers
...
def entry()
	...
	soup = BeautifulSoup(content, features="html.parse")
	#print(soup.prettify)
