# For refrence https://github.com/avinashkranjan/Amazing-Python-Scripts/blob/master/Select%20Stocks%20by%20volume%20Increase/script.py
...
if(ch == 1):
	...
	days = input("Enter number of days for comparison: ")
	timeincrease = input(
		...
		for stock in df[stocks]:
			...
			if '^' in stock:
				...
				try:
					...
					if todays_volume > previous_averaged_volume * timeincrease:
