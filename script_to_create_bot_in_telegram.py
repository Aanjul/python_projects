# For refrence https://github.com/avinashkranjan/Amazing-Python-Scripts/tree/master/Telegram-Bot
...
# Displays message when incorrect command is sent
		...
		def unknown(update, context):
			...
			# your token has to be provided in <<YOUR-TOKEN>> place
			...
			def main():
				...
				disp.add_hander(CommandHandler('play', play))
