# For refrence https://github.com/avinashkranjan/Amazing-Python-Scripts/blob/master/Custom-Bulk-Email-Sender/customBulkEmailSender.py
...
for mail_to in mail_list:
	...
	message = f'Dear {studentName}, \n'\
			  f'We inform you that you will be interviewed by ${interviewerlist[find_des]}. Please wait for the concern mail from your interviewer. \n'\
			  '\n' \
			  'Cheers'
