# For refrence https://github.com/realpython/python-scripts/blob/master/scripts/33_country_code.py

# this file requires a json file
            ...
            for csv_row in reader:
                for json_row in all_countries:
                    if csv_row[0] == json_row["countryCode"]:
                        ...
                        countryNames.append(json_row["countryNames"])
