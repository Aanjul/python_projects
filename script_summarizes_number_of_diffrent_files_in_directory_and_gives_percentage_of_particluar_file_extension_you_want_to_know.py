# For refrence https://github.com/fnplus/Python-scripts-collection/blob/master/DirectorySummarizer/directory_summarizer.py
	...
	def percent(files, ext):
		...
		for i in files:
			...
			try:
				...
				if count is 0:
					print("WARNING:number of files found with extension is 0. Check you extension.")
...
if __name__ == "__main__":
	...
	if str(type(result))=="<class 'tuple'>":
		...
		print(f"{extension} files :/t", result[2])
		print("Total files :\t", result[1])
		print("\n------------------------")
		print("Percentage :/t", result[0],"%")
		print("---------------------------")
		if flag.lower() == "n":
			print("====================================")
		else:
